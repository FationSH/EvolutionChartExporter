...
INSERT INTO `menu_links` VALUES (1,1,1,2,0,'/admin/system/dashboard',NULL,'Dashboard','_self',1,'/admin/system/dashboard\r\n/admin\r\n/admin/','any',1),(2,1,3,10,0,'/admin/system/structure','','Structure','_self',1,'','auto',1),(3,1,11,20,0,'/admin/content/manage','','Content','_self',1,'/admin/content/manage*\r\n/admin/content/comments*\r\n/admin/content/types*\r\n/admin/content/fields*','any',1),(4,1,23,28,0,'/admin/system/themes','','Appearance','_self',1,'admin/system/themes*','any',1),(5,1,29,34,0,'/admin/system/plugins','','Extensions','_self',1,'admin/system/plugins*','any',1),(6,1,35,44,0,'/admin/user/manage','','Users & Security','_self',1,'/admin/user*','any',1),(7,1,51,52,0,'/admin/system/configuration','','Configuration','_self',0,'/admin/system/configuration*','any',1),(8,1,53,54,0,'/admin/system/help','','Help','_self',0,'/admin/system/help*','any',1),(9,1,4,5,2,'/admin/block/manage','Configure what block content appears in your site\'s sidebars and other regions.','Blocks','_self',0,'/admin/block/*','any',1),(11,1,6,7,2,'/admin/menu/manage','Add new menus to your site, edit existing menus, and rename and reorganize menu links.','Menus','_self',0,NULL,NULL,1),(12,1,8,9,2,'/admin/taxonomy/vocabularies','Manage tagging, categorization, and classification of your content.','Taxonomy','_self',0,NULL,NULL,1),(13,1,45,50,0,'/admin/locale/','','Languages','_self',1,'/admin/locale/*','any',1),(14,2,3,4,0,'/page/about.html','','About','_self',0,NULL,NULL,1),(16,2,1,2,0,'/','','Home','_self',0,NULL,NULL,1),(17,2,5,6,0,'/find/type:article','','Blog','_self',0,'/article/*.html\r\n/find/*type:article*','any',1),(18,1,12,13,3,'/admin/content/manage/index','','Contents List','',0,'','auto',1),(19,1,14,15,3,'/admin/content/manage/create','','Create New Content','',0,'','auto',1),(20,1,16,17,3,'/admin/content/types','','Content Types','',0,'/admin/content/types*\r\n/admin/content/fields*','any',1),(21,1,18,19,3,'/admin/content/comments/','','Comments','',0,'/admin/content/comments/*','any',1),(22,1,24,25,4,'/admin/system/themes/index','','Themes','',0,'/admin/system/themes\r\n/admin/system/themes/index','any',1),(23,1,26,27,4,'/admin/system/themes/install','','Install New Theme','',0,'','auto',1),(24,1,30,31,5,'/admin/system/plugins/index','','Plugins','',0,'','auto',1),(25,1,32,33,5,'/admin/system/plugins/install','','Install New Plugin','',0,'','auto',1),(26,1,36,37,6,'/admin/user/manage/','','Users List','',0,'/admin/user/manage/*','any',1),(27,1,38,39,6,'/admin/user/roles','','User Roles','',0,'','auto',1),(28,1,40,41,6,'/admin/user/permissions','','Permissions','',0,'','auto',1),(29,1,46,47,13,'/admin/locale/manage/index','','Installed Languages','',0,'','auto',1),(30,1,48,49,13,'/admin/locale/manage/add','','Add New Language','',0,'','auto',1),(31,1,42,43,6,'/admin/user/fields','','Virtual Fields','',0,'/admin/user/fields*','any',1),(32,1,21,22,0,'/admin/media_manager/explorer','','Media','',1,'/admin/media_manager/explorer*','any',1);
...
-- Dump completed on 2015-05-08  4:13:08
