CREATE TABLE binomial_model (	    model_id integer NOT NULL,
...
CREATE TABLE multinomial_model (	    model_id integer NOT NULL,
	    mse double precision,
	    r_squared double precision,
	    logloss double precision,
	    PRIMARY KEY (model_id),
...
CREATE TABLE regression_model (	    model_id integer NOT NULL,
	    mse double precision,
	    r_squared double precision,
