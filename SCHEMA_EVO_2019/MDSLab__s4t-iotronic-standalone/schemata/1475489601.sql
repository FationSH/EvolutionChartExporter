...
CREATE TABLE IF NOT EXISTS `measures` (	  `id` INT(11) NOT NULL AUTO_INCREMENT,
	  `name` VARCHAR(20) NOT NULL,
	  `read_plugin` VARCHAR(20) NOT NULL,
	  `elaborate_plugin` VARCHAR(20) NULL DEFAULT NULL,
	  PRIMARY KEY (`id`))	ENGINE = InnoDB	AUTO_INCREMENT = 9	DEFAULT CHARACTER SET = utf8;

CREATE TABLE IF NOT EXISTS `measures_injected` (	  `board_id` INT(11) NOT NULL,
	  `measure_id` INT(11) NOT NULL,
	  `pin` VARCHAR(20) NOT NULL,
	  `period` DOUBLE NULL DEFAULT NULL,
	  `state` VARCHAR(20) NULL DEFAULT NULL)	ENGINE = InnoDB	DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `reverse_cloud_services` (	  `board_id` INT(8) NOT NULL,
