CREATE TABLE IF NOT EXISTS `apps_branding` (	  `brand_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  KEY `brand_main_img` (`brand_main_img`)	) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `apps_feed` (	  `tf_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  KEY `tf_date` (`tf_date`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `apps_feedback` (	  `feed_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`feed_id`),
	  KEY `rcp_id` (`rcp_id`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `apps_feedback_recipient` (	  `rcp_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`rcp_id`),
	  KEY `rcp_order_num` (`rcp_order_num`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6 ;
...
CREATE TABLE IF NOT EXISTS `apps_feed_uploads` (	  `afu_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  KEY `afu_order_num_idx` (`afu_order_num`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `apps_news` (	  `news_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  KEY `news_is_top` (`news_is_top`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=6 ;
...
CREATE TABLE IF NOT EXISTS `apps_news_comment` (	  `comment_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  KEY `u_id` (`u_id`)	) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `apps_news_uploads` (	  `anu_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  KEY `news_id` (`news_id`),
	  KEY `session_id` (`session_id`),
	  KEY `anu_order_num_idx` (`anu_order_num`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=6 ;

CREATE TABLE IF NOT EXISTS `apps_tops` (	  `top_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  KEY `tg_id` (`tg_id`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `apps_tops_translation` (	  `top_id` int(10) unsigned NOT NULL,
	  `lang_id` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `apps_tops_uploads` (	  `tu_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  KEY `top_id` (`top_id`),
	  KEY `session_id` (`session_id`),
	  KEY `tu_order_num_idx` (`tu_order_num`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `apps_tops_uploads_tags` (	  `tu_id` int(10) unsigned NOT NULL,
	  `tag_id` int(10) unsigned NOT NULL,
	  PRIMARY KEY (`tu_id`,
`tag_id`),
	  KEY `tag_id` (`tag_id`)	) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `apps_top_groups` (	  `tg_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  `tg_order_num` int(10) unsigned NOT NULL DEFAULT '1',
	  PRIMARY KEY (`tg_id`),
	  KEY `tg_order_num` (`tg_order_num`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `apps_top_groups_translation` (	  `tg_id` int(10) unsigned NOT NULL,
	  `lang_id` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `apps_vote` (	  `vote_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`vote_id`),
	  KEY `vote_is_active` (`vote_is_active`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `apps_vote_question` (	  `vote_question_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  KEY `vote_id` (`vote_id`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6 ;
...
CREATE TABLE IF NOT EXISTS `form_5` (	  `pk_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  KEY `form_5_field_6` (`form_5_field_6`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6 ;
...
CREATE TABLE IF NOT EXISTS `form_5_field_5_multi_values` (	  `fk_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`fk_id`),
	  KEY `fk_order_num` (`fk_order_num`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4 ;
...
CREATE TABLE IF NOT EXISTS `form_5_field_6` (	  `fk_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
	  `fk_order_num` int(10) unsigned DEFAULT '1',
	  PRIMARY KEY (`fk_id`),
	  KEY `fk_order_num` (`fk_order_num`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `frm_forms` (	  `form_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  KEY `form_is_active` (`form_is_active`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6 ;
...
CREATE TABLE IF NOT EXISTS `share_access_level` (	  `smap_id` int(10) unsigned NOT NULL,
...
`domain_host`,
`domain_port`,
`domain_root`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `share_languages` (	  `lang_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`lang_id`),
	  KEY `idx_abbr` (`lang_abbr`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;

CREATE TABLE IF NOT EXISTS `share_lang_tags` (	  `ltag_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  `ltag_name` varchar(70) NOT NULL,
	  PRIMARY KEY (`ltag_id`),
	  UNIQUE KEY `ltag_name` (`ltag_name`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2060 ;

CREATE TABLE IF NOT EXISTS `share_lang_tags_translation` (	  `ltag_id` int(10) unsigned NOT NULL,
	  `lang_id` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `share_session` (	  `session_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  KEY `session_expires` (`session_expires`)	) ENGINE=MEMORY DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
`smap_segment`),
	  ...
	  KEY `brand_id` (`brand_id`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3644 ;
...
CREATE TABLE IF NOT EXISTS `share_sitemap_translation` (	  `smap_id` int(10) unsigned NOT NULL,
	  `lang_id` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `share_sitemap_uploads` (	  `ssu_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  KEY `smap_id` (`smap_id`),
	  KEY `session_id` (`session_id`),
	  KEY `ssu_order_num_idx` (`ssu_order_num`)	) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `share_sites` (	  `site_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`site_id`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `share_tags` (	  `tag_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`tag_id`),
	  UNIQUE KEY `tag_code` (`tag_code`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6 ;

CREATE TABLE IF NOT EXISTS `share_tags_translation` (	  `tag_id` int(11) unsigned NOT NULL,
	  `lang_id` int(11) unsigned NOT NULL,
...
`tb_num`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=61 ;

CREATE TABLE IF NOT EXISTS `share_textblocks_translation` (	  `tb_id` int(10) unsigned NOT NULL,
	  `lang_id` int(10) unsigned NOT NULL,
...
`upl_views`),
	  ...
	  KEY `upl_is_flv` (`upl_is_flv`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=13 ;
...
CREATE TABLE IF NOT EXISTS `share_widgets` (	  `widget_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`widget_id`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4 ;
...
CREATE TABLE IF NOT EXISTS `user_groups` (	  `group_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  KEY `group_default` (`group_default`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5 ;
...
CREATE TABLE IF NOT EXISTS `user_group_rights` (	  `right_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`right_id`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4 ;
...
CREATE TABLE IF NOT EXISTS `user_users` (	  `u_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  `u_position` varchar(255) DEFAULT NULL	  PRIMARY KEY (`u_id`),
	  UNIQUE KEY `u_login` (`u_name`),
	  UNIQUE KEY `u_fbid` (`u_fbid`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=23 ;

CREATE TABLE IF NOT EXISTS `user_user_groups` (	  `u_id` int(10) unsigned NOT NULL,
	  `group_id` int(10) unsigned NOT NULL,
	  PRIMARY KEY (`u_id`,
`group_id`),
	  KEY `group_id` (`group_id`)	) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE share_sites_properties (	  prop_id int(10) unsigned NOT NULL AUTO_INCREMENT,
	  site_id int(10) unsigned DEFAULT NULL,
	  prop_name varchar(255) NOT NULL,
	  prop_value text NOT NULL,
	  PRIMARY KEY (prop_id),
	  UNIQUE KEY site_id (site_id,
prop_name)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8;

CREATE TABLE share_action_log (	  al_id int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (al_id)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8;
