...
CREATE TABLE IF NOT EXISTS `apps_feed_uploads` (	  `tf_id` int(10) unsigned NOT NULL,
	  `upl_id` int(10) unsigned NOT NULL,
	  `upl_order_num` int(10) unsigned DEFAULT '1',
	  PRIMARY KEY (`tf_id`,
`upl_id`),
	  KEY `upl_order_num` (`upl_order_num`),
	  KEY `upl_id` (`upl_id`)	) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `apps_news_uploads` (	  `news_id` int(10) unsigned NOT NULL,
	  `upl_id` int(10) unsigned NOT NULL,
	  `upl_order_num` int(10) unsigned NOT NULL DEFAULT '0',
	  PRIMARY KEY (`news_id`,
`upl_id`,
`upl_order_num`),
	  KEY `upl_id` (`upl_id`)	) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
`domain_host`,
`domain_port`,
`domain_root`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=197 ;
...
CREATE TABLE IF NOT EXISTS `share_lang_tags` (	  `ltag_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`ltag_id`),
	  UNIQUE KEY `ltag_name` (`ltag_name`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2026 ;
...
CREATE TABLE IF NOT EXISTS `share_session` (	  `session_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  KEY `session_expires` (`session_expires`)	) ENGINE=MEMORY  DEFAULT CHARSET=utf8 AUTO_INCREMENT=15 ;
...
`smap_segment`),
	  ...
	  KEY `brand_id` (`brand_id`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3642 ;
...
CREATE TABLE IF NOT EXISTS `share_sitemap_uploads` (	  `smap_id` int(10) unsigned NOT NULL,
	  `upl_id` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `share_sites` (	  `site_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  `site_ga_code` text,
	  PRIMARY KEY (`site_id`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `share_tags` (	  `tag_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`tag_id`),
	  UNIQUE KEY `tag_name` (`tag_name`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=48 ;
...
`upl_views`),
	  ...
	  KEY `upl_is_active` (`upl_is_active`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=13 ;
...
CREATE TABLE IF NOT EXISTS `user_ban_ips` (	  `ban_ip_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  `ban_ip` int(4) unsigned NOT NULL,
	  `ban_ip_end_date` date NOT NULL,
	  PRIMARY KEY (`ban_ip_id`),
	  UNIQUE KEY `i_ban_ip_uniq` (`ban_ip`),
	  KEY `i_ban_ip_end_date` (`ban_ip_end_date`)	) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;

CREATE TABLE IF NOT EXISTS `user_fb_storage` (	  `var_name` char(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `user_users_ban` (	  `u_id` int(10) unsigned NOT NULL,
...
CREATE TABLE `share_sitemap_comment` (	  `comment_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  CONSTRAINT `share_sitemap_comment_ibfk_3` FOREIGN KEY (`u_id`) REFERENCES `user_users` (`u_id`) ON DELETE CASCADE ON UPDATE CASCADE	) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE `apps_news_comment` (	  `comment_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  `comment_parent_id` int(10) unsigned DEFAULT NULL,
	  `target_id` int(10) unsigned NOT NULL,
	  `u_id` int(10) unsigned DEFAULT NULL,
	  `comment_created` datetime NOT NULL,
	  ...
	  CONSTRAINT `apps_news_comment_ibfk_3` FOREIGN KEY (`u_id`) REFERENCES `user_users` (`u_id`) ON DELETE CASCADE ON UPDATE CASCADE	) ENGINE=InnoDB DEFAULT CHARSET=utf8;
