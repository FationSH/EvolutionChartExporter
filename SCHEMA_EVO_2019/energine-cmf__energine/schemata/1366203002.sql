...
CREATE TABLE `apps_news` (	  `news_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  CONSTRAINT `apps_news_ibfk_1` FOREIGN KEY (`smap_id`) REFERENCES `share_sitemap` (`smap_id`) ON DELETE CASCADE ON UPDATE CASCADE	) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `share_session` (	  `session_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  KEY `session_expires` (`session_expires`)	) ENGINE=MEMORY AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
...
`smap_segment`),
	  ...
	  CONSTRAINT `share_sitemap_ibfk_9` FOREIGN KEY (`site_id`) REFERENCES `share_sites` (`site_id`) ON DELETE CASCADE ON UPDATE CASCADE	) ENGINE=InnoDB AUTO_INCREMENT=3630 DEFAULT CHARSET=utf8;
...
CREATE TABLE `share_tags` (	  `tag_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`tag_id`),
	  UNIQUE KEY `tag_name` (`tag_name`)	) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8;
...
`upl_views`),
	  ...
	  CONSTRAINT `share_uploads_ibfk_1` FOREIGN KEY (`upl_pid`) REFERENCES `share_uploads` (`upl_id`) ON DELETE CASCADE ON UPDATE CASCADE	) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;
...
CREATE TABLE `share_widgets` (	  `widget_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`widget_id`)	) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
