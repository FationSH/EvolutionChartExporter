...
CREATE TABLE `apps_feed` (	  `tf_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  KEY `tf_date` (`tf_date`),
	  CONSTRAINT `apps_feed_ibfk_1` FOREIGN KEY (`smap_id`) REFERENCES `share_sitemap` (`smap_id`) ON DELETE CASCADE ON UPDATE CASCADE	) ENGINE=InnoDB AUTO_INCREMENT=152 DEFAULT CHARSET=utf8;
...
CREATE TABLE `apps_feedback` (	  `feed_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`feed_id`),
	  KEY `rcp_id` (`rcp_id`),
	  CONSTRAINT `apps_feedback_ibfk_1` FOREIGN KEY (`rcp_id`) REFERENCES `trku_feedback_recipient` (`rcp_id`) ON DELETE CASCADE ON UPDATE CASCADE	) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `apps_news` (	  `news_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  CONSTRAINT `apps_news_ibfk_1` FOREIGN KEY (`smap_id`) REFERENCES `share_sitemap` (`smap_id`) ON DELETE CASCADE ON UPDATE CASCADE	) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
`domain_host`,
`domain_port`,
`domain_root`)	) ENGINE=InnoDB AUTO_INCREMENT=282 DEFAULT CHARSET=utf8;

CREATE TABLE `share_lang_tags` (	  `ltag_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  `ltag_name` varchar(70) NOT NULL DEFAULT '',
	  PRIMARY KEY (`ltag_id`),
	  UNIQUE KEY `ltag_name` (`ltag_name`)	) ENGINE=InnoDB AUTO_INCREMENT=2011 DEFAULT CHARSET=utf8;
...
CREATE TABLE `share_session` (	  `session_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  KEY `session_expires` (`session_expires`)	) ENGINE=MEMORY AUTO_INCREMENT=27127 DEFAULT CHARSET=utf8;
...
`smap_segment`),
	  ...
	  CONSTRAINT `share_sitemap_ibfk_9` FOREIGN KEY (`site_id`) REFERENCES `share_sites` (`site_id`) ON DELETE CASCADE ON UPDATE CASCADE	) ENGINE=InnoDB AUTO_INCREMENT=3835 DEFAULT CHARSET=utf8;
...
CREATE TABLE `share_sites` (	  `site_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  `site_ga_code` text,
	  PRIMARY KEY (`site_id`)	) ENGINE=InnoDB AUTO_INCREMENT=248 DEFAULT CHARSET=utf8;
...
CREATE TABLE `share_tags` (	  `tag_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`tag_id`),
	  UNIQUE KEY `tag_name` (`tag_name`)	) ENGINE=InnoDB AUTO_INCREMENT=6169 DEFAULT CHARSET=utf8;
...
`tb_num`),
	  CONSTRAINT `share_textblocks_ibfk_1` FOREIGN KEY (`smap_id`) REFERENCES `share_sitemap` (`smap_id`) ON DELETE CASCADE	) ENGINE=InnoDB AUTO_INCREMENT=71 DEFAULT CHARSET=utf8;
...
`upl_views`),
	  ...
	  CONSTRAINT `share_uploads_ibfk_1` FOREIGN KEY (`upl_pid`) REFERENCES `share_uploads` (`upl_id`) ON DELETE CASCADE ON UPDATE CASCADE	) ENGINE=InnoDB AUTO_INCREMENT=903038 DEFAULT CHARSET=utf8;
...
CREATE TABLE `share_widgets` (	  `widget_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`widget_id`)	) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
...
CREATE TABLE `user_users` (	  `u_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  UNIQUE KEY `u_fbid` (`u_fbid`)	) ENGINE=InnoDB AUTO_INCREMENT=28600 DEFAULT CHARSET=utf8;
