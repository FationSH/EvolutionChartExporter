...
CREATE TABLE `domains` (	  `id` int(11) NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`id`),
	  UNIQUE KEY `name_index` (`name`)	) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1;
...
CREATE TABLE `hostcontrol_users` (	  `hostcontrol_id` int(11) NOT NULL AUTO_INCREMENT,
	  ...
	  KEY `system_username` (`system_username`)	) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=latin1;
...
CREATE TABLE `mail_domains` (	  `domain_id` int(11) NOT NULL AUTO_INCREMENT,
	  ...
	  KEY `domain` (`domain`),
	  KEY `system_username` (`system_username`)	) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1;
...
CREATE TABLE `mail_users` (	  `email_id` int(11) NOT NULL AUTO_INCREMENT,
	  ...
	  KEY `domain` (`domain`),
	  KEY `email` (`email`),
	  CONSTRAINT `mail_users_ibfk_1` FOREIGN KEY (`domain`) REFERENCES `mail_domains` (`domain`) ON DELETE CASCADE	) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1;
...
`ordername`),
	  CONSTRAINT `records_ibfk_1` FOREIGN KEY (`domain_id`) REFERENCES `domains` (`id`) ON DELETE CASCADE	) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=latin1;
...
'N') NOT NULL,
	  ...
	  KEY `domain` (`domain`),
	  KEY `system_username` (`system_username`)	) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=latin1;
