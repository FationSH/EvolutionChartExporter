...
--
-- Table structure for table `oc_image_description`
--

DROP TABLE IF EXISTS `oc_image_description`;
CREATE TABLE `oc_image_description` (
...
--
-- Dumping data for table `oc_image_description`
--
