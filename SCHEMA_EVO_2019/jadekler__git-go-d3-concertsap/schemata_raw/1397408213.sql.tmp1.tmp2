CREATE TABLE `band` (	  `id` int(11) NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`id`)	) ENGINE=InnoDB AUTO_INCREMENT=335 DEFAULT CHARSET=latin1;
...
`concert_id`)	) ENGINE=InnoDB AUTO_INCREMENT=397 DEFAULT CHARSET=latin1;
...
`concert_id`,
`date`,
`time`)	) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;
...
CREATE TABLE `state` (	  `id` int(11) NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`id`),
	  UNIQUE KEY `state` (`acronym`)	) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;
...
CREATE TABLE `ticket_record` (	  `id` int(11) NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`id`)	) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=latin1;
