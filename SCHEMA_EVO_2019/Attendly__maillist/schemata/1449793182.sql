...
'deleted') NOT NULL,
	  ...
	  PRIMARY KEY (`id`),
	  KEY `email` (`email`,
`status`)	) ENGINE=InnoDB AUTO_INCREMENT=118 DEFAULT CHARSET=utf8;
...
'failed') NOT NULL,
	  ...
	  CONSTRAINT `campaign_ibfk_1` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`)	) ENGINE=InnoDB AUTO_INCREMENT=83 DEFAULT CHARSET=utf8;
...
'deleted') NOT NULL,
	  ...
	  CONSTRAINT `list_ibfk_1` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`)	) ENGINE=InnoDB AUTO_INCREMENT=183 DEFAULT CHARSET=utf8;
...
'unsubscribed') NOT NULL,
	  ...
	  PRIMARY KEY (`id`),
	  KEY `account_id` (`account_id`),
	  CONSTRAINT `subscriber_ibfk_1` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`)	) ENGINE=InnoDB AUTO_INCREMENT=77 DEFAULT CHARSET=utf8;
