...
'deleted') NOT NULL,
	  ...
	  PRIMARY KEY (`id`),
	  KEY `email` (`email`,
`status`)	) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8;
...
'failed') NOT NULL,
	  ...
	  CONSTRAINT `campaign_ibfk_1` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`)	) ENGINE=InnoDB AUTO_INCREMENT=65 DEFAULT CHARSET=utf8;
...
'deleted') NOT NULL,
	  ...
	  CONSTRAINT `list_ibfk_1` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`)	) ENGINE=InnoDB AUTO_INCREMENT=123 DEFAULT CHARSET=utf8;
...
`email`),
	  CONSTRAINT `subscriber_ibfk_1` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`)	) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8;
