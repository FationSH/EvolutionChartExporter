CREATE TABLE `php_session` (	  `session_id` varchar(32) NOT NULL DEFAULT '',
	  ...
	  KEY `last_updated` (`last_updated`)	) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
`int_user1_id`)	) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
'confirmed') DEFAULT 'unconfirmed',
	  ...
	  KEY `tbl_user_email` (`var_email`)	) ENGINE=InnoDB AUTO_INCREMENT=414 DEFAULT CHARSET=latin1;
