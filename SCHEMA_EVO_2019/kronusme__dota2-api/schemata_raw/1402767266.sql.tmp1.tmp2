CREATE TABLE `leagues` (	  `leagueid` mediumint(4) unsigned NOT NULL,
...
CREATE TABLE `league_prize_pools` (	  `league_id` MEDIUMINT(8) UNSIGNED NOT NULL,
	  `prize_pool` INT(10) UNSIGNED NOT NULL,
	  `date` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	  PRIMARY KEY (`league_id`,
 `date`),
	  CONSTRAINT `FK_league_prize_pools_leagues` FOREIGN KEY (`league_id`) REFERENCES `leagues` (`leagueid`)	)	  COLLATE='utf8_general_ci'	  ENGINE=InnoDB;

CREATE TABLE `matches` (	  `match_id` int(20) unsigned NOT NULL,
...
CREATE TABLE `users` (	  `account_id` int(20) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `slots` (	  `id` mediumint(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  CONSTRAINT `FK_slots_users` FOREIGN KEY (`account_id`) REFERENCES `users` (`account_id`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;

CREATE TABLE `ability_upgrades` (	  `slot_id` mediumint(10) unsigned NOT NULL,
...
CREATE TABLE `additional_units` (	  `slot_id` mediumint(10) unsigned NOT NULL,
...
CREATE TABLE `picks_bans` (	  `id` mediumint(20) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  CONSTRAINT `FK_picks_bans_matches` FOREIGN KEY (`match_id`) REFERENCES `matches` (`match_id`)	) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
