CREATE TABLE IF NOT EXISTS `ability_upgrades` (	  `slot_id` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `additional_units` (	  `slot_id` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `matches` (	  `id` int(10) NOT NULL AUTO_INCREMENT,
	  ...
	  KEY `FK_matches_game_mods` (`game_mode`)	) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `picks_bans` (	  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
	  `match_id` bigint(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `slots` (	  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
	  ...
	  CONSTRAINT `FK_slots_matches` FOREIGN KEY (`match_id`) REFERENCES `matches` (`match_id`)	) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `users` (	  `account_id` bigint(20) NOT NULL DEFAULT '0',
