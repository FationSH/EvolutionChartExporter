CREATE TABLE `cashbook` (	  `id` int(11) NOT NULL AUTO_INCREMENT,
	  ...
	  CONSTRAINT `fk_cashbook_tb_category` FOREIGN KEY (`category_id`) REFERENCES `category` (`id_category`) ON DELETE NO ACTION ON UPDATE NO ACTION	) ENGINE=InnoDB AUTO_INCREMENT=611 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Control financial movement';
