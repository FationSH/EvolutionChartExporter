...
CREATE TABLE pubsub_item (	  nodeid bigint,
	  ...
	  payload mediumtext NOT NULL	) ENGINE=InnoDB CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE mix_channel (	    channel text NOT NULL,
	    service text NOT NULL,
...
CREATE TABLE mix_participant (	    channel text NOT NULL,
	    service text NOT NULL,
	    username text NOT NULL,
	    domain text NOT NULL,
	    jid text NOT NULL,
...
CREATE TABLE mix_subscription (	    channel text NOT NULL,
	    service text NOT NULL,
	    username text NOT NULL,
	    domain text NOT NULL,
	    node text NOT NULL,
	    jid text NOT NULL	) ENGINE=InnoDB CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

CREATE TABLE mix_pam (	    username text NOT NULL,
	    server_host text NOT NULL,
...
CREATE TABLE mqtt_pub (	    username varchar(191) NOT NULL,
