...
CREATE TABLE `fcs_cronjob_logs` (	  `id` int(11) NOT NULL AUTO_INCREMENT,
	  `cronjob_id` int(10) unsigned NOT NULL,
	  `created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
	  `success` tinyint(3) unsigned NOT NULL,
	  PRIMARY KEY (`id`)	) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE `fcs_cronjobs` (	  `id` int(11) NOT NULL AUTO_INCREMENT,
...
6) NOT NULL DEFAULT '0.000000',
	  ...
	  `delivery_rhythm_send_order_list_day_delta` varchar(10) DEFAULT NULL,
