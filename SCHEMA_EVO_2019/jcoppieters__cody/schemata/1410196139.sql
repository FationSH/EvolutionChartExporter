CREATE TABLE `atoms` (	  `id` int(11) NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`id`)	) ENGINE=MyISAM AUTO_INCREMENT=32 DEFAULT CHARSET=utf8;
...
CREATE TABLE `content` (	  `id` int(11) NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`id`),
	  KEY `item` (`item`,
`language`)	) ENGINE=MyISAM AUTO_INCREMENT=30 DEFAULT CHARSET=utf8;
...
CREATE TABLE `items` (	  `id` int(11) NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`id`),
	  KEY `parent_idx` (`parent`)	) ENGINE=MyISAM AUTO_INCREMENT=106 DEFAULT CHARSET=utf8;
...
CREATE TABLE `templates` (	  `id` int(11) NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`id`)	) ENGINE=MyISAM AUTO_INCREMENT=104 DEFAULT CHARSET=utf8;
