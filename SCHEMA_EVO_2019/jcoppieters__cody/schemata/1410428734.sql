CREATE TABLE `atoms` (	  `id` int(11) NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`id`)	) ENGINE=MyISAM AUTO_INCREMENT=53 DEFAULT CHARSET=utf8;
...
CREATE TABLE `content` (	  `id` int(11) NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`id`),
	  KEY `item` (`item`,
`language`)	) ENGINE=MyISAM AUTO_INCREMENT=119 DEFAULT CHARSET=utf8;
...
CREATE TABLE `data` (	  `id` int(11) NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`id`)	) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8;

CREATE TABLE `domains` (	  `id` varchar(32) NOT NULL DEFAULT '',
	  `name` varchar(32) DEFAULT '?'	) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `items` (	  `id` int(11) NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`id`),
	  KEY `parent_idx` (`parent`)	) ENGINE=MyISAM AUTO_INCREMENT=158 DEFAULT CHARSET=utf8;
...
CREATE TABLE `levels` (	  `id` int(11) DEFAULT NULL,
	  `name` varchar(32) DEFAULT NULL	) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `pages` (	  `item` int(11) NOT NULL DEFAULT '0',
	  ...
	  `updated` datetime DEFAULT '0000-00-00 00:00:00',
	  PRIMARY KEY (`item`,
`language`)	) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `templates` (	  `id` int(11) NOT NULL AUTO_INCREMENT,
	  ...
	  PRIMARY KEY (`id`)	) ENGINE=MyISAM AUTO_INCREMENT=107 DEFAULT CHARSET=utf8;
...
`active`)	) ENGINE=MyISAM AUTO_INCREMENT=12 DEFAULT CHARSET=utf8;
